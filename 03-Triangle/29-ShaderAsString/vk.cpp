...
#include <SPIRV/GlslangToSpv.h> // this was sufficient til 1.3.28 vulkan version
#include <Public/ShaderLang.h> // this is required from recent versions!

// vulkan related libraries
#pragma comment(lib, "vulkan-1.lib")

// glslang/spirv related libraries
#pragma comment(lib, "glslang.lib") // this is required from recent versions!
#pragma comment(lib, "SPIRV-Tools.lib") // nedded from the beigining 
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
    ...
    hwnd = CreateWindowEx(WS_EX_APPWINDOW,
            szAppName,
            TEXT("AMK_Vulkan : Shader As String!"),

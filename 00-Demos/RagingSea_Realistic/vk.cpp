...
SeaUiState gSeaUiState = {
    ...
    1.9f,
    3.0f,
    {0.012f, 0.149f, 0.286f, 0.0f},
    {0.149f, 0.522f, 0.675f, 0.0f},
    {0.678f, 0.851f, 0.949f, 0.0f},
    {0.063f, 0.286f, 0.561f, 0.0f},
    {-0.4f, 0.78f, -0.48f},
    1.35f,
    {1.0f, 0.94f, 0.86f, 0.0f},
    0.18f,
    1.25f,
    4.8f,
    0.82f,
...
VkResult updateUniformBuffer(void) {
    ...
    myUniformData.cameraPosition[3] = (float) myClock.getElapsedTime() * gSeaUiState.timeScale;
    ...
    if(glm::length(sunDirection) < 0.001f) {
        sunDirection = glm::vec3(-0.4f, 0.78f, -0.48f);
    }
...
bool buildImGuiUI(void) {
    ...
    if(gShowSeaControls) {
        ...
        changed |= ImGui::SliderFloat("Sun Intensity", &gSeaUiState.sunIntensity, 0.1f, 3.0f);
